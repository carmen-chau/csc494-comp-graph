  ...
  return (
    ...
    paddingLeft: "40px"}}>
      ...
      <div style={{ 
        ...
        <CytoscapeComponent
          elements={[...nodes, ...edges.filter((edge) => edge.data.visible === true)]} // Combine nodes and edges. Note: For edges, used the filter() function to only show edges where the visible attribute is set to true
